...
class TabletProfileBody extends StatefulWidget {
  const TabletProfileBody({super.key});

  @override
  State<TabletProfileBody> createState() => _TabletProfileBodyState();
}

class _TabletProfileBodyState extends State<TabletProfileBody> {
  @override
